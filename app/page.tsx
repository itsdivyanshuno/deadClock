/**
 * @module app/page
 * @description Root Client Component — the single UI orchestrator for Deadline.
 *
...
/**
 * Maps each priority level to a Tailwind badge CSS class string.
 * These classes are applied to the small priority pills shown on task cards
 * in the sidebar.  Keys not found in this map fall back to the medium entry
 * at each call site.
 *
 * @constant
 ...
 * Used for visual category identification in task cards and sidebar items.
 * Falls back to the General (📋) entry when the category is not in this map.
 *
 * @constant
 * @type {Record<string, string>}
 */
